...
class PreferencesDialog(QDialog):
    ...
    KEY_CAPTURES_SUBDIR = "session/captures_subdir"

    # Wartości domyślne
    DEFAULT_SESSION_DIR = os.path.expanduser("~/Obrazy/sessions")
    DEFAULT_CAPTURES_SUBDIR = "captures"
    ...
    def get_captures_subdir() -> str:
        """Zwraca nazwę podkatalogu captures z QSettings."""
        settings = QSettings("Grzeza", "SessionsAssistant")
        return settings.value(
            PreferencesDialog.KEY_CAPTURES_SUBDIR,
            PreferencesDialog.DEFAULT_CAPTURES_SUBDIR
        )
