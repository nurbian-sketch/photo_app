"""
DarktableRunningDialog — informacja że darktable GUI blokuje bazę.
Układ identyczny z NoCameraDialog / NoSdCardDialog.
"""
import os
...
_IMG = os.path.join("assets", "pictures", "darktable-is-running.jpg")


class DarktableRunningDialog(QDialog):
    """
    Wyświetlany gdy darktable GUI trzyma lock na data.db.
    accept() = OK (caller sprawdza ponownie czy darktable zamknięte),
    reject() = Cancel (caller rezygnuje z developmentu).
    """

    def __init__(self, parent=None):
        super().__init__(parent)
        self.setWindowTitle(self.tr("Darktable is running"))
